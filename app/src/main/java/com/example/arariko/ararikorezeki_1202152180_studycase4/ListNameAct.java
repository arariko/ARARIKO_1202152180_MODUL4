package com.example.arariko.ararikorezeki_1202152180_studycase4;
...
public class ListNameAct extends AppCompatActivity {

    //membuat array nama mahasiswa
    private String[] nama = { "George","Santi", "Sylva", "Arariko", "Anton", "Yola", "Raline", "Bambang", "Indra", "Pevi", "Abudi", "Jason"
            ,"Lina", "Ratna", "Sheva"};
    ListView listnama;
    Button btnmulai;
    ...
    class mytask extends AsyncTask<Void,String,String> {
        ...
        protected void onPreExecute() {
            ...
            progressdialog = new ProgressDialog(ListNameAct.this);
